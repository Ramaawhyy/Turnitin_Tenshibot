...
<head>
  ...
  <title>Register - Tenshibot</title>
              ...
              <form method="POST" action="{{ route('register') }}">
                ...
                <div class="card-wrapper p-3">
                  ...
                  <div class="card card-plain">
                    ...
                    <div class="card-body">
                      <div class="mb-3">
                        <input type="text" class="form-control form-control-lg" name="name" placeholder="Name" required autofocus>
                      </div>
                      <div class="mb-3">
                        <input type="email" class="form-control form-control-lg" name="email" placeholder="Email" required autocomplete="username">
                      </div>
                      <div class="mb-3">
